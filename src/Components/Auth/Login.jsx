...
function Login() {
  function handleSignup() {
    window.location.href = `https://accounts.google.com/o/oauth2/auth?client_id=125466525384-cdvft8moir56fj66b8jhmgn6lm52c82u.apps.googleusercontent.com&redirect_uri=https://email-segregator-backend-1.onrender.com/api/v1/auth/google/callback&response_type=code&scope=email%20profile%20https://www.googleapis.com/auth/gmail.modify&access_type=offline&prompt=consent`;
  }
  return (
    // <div>
